...
//         await sendMail(existingUser.email,`OTP Verification for Your E-Shop Account`,`Your One-Time Password (OTP) for account verification is: <b>${otp}</b>.</br>Do not share this OTP with anyone for security reasons`)
