...
export const PrevButton = (props: ButtonProps) => {
    return (
        <button
            className={clsx(
                'absolute w-14 h-14 rounded-full bg-gray-200 border border-gray-400 flex items-center justify-center',
                'top-1/2 -translate-y-1/2 left-1 -translate-x-1/2'
            )}
            type="button"
            {...props}
        >
...
export const NextButton = (props: ButtonProps) => {
    return (
        <button
            className={clsx(
                'absolute w-14 h-14 rounded-full bg-gray-200 border border-gray-400 flex items-center justify-center',
                'top-1/2 -translate-y-1/2 right-1 translate-x-1/2'
            )}
            type="button"
            {...props}
        >
